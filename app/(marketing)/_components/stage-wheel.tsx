...
export function StageWheel() {
  return (
    <section className="overflow-hidden bg-cream w-full z-10 border-white/40 border-t pt-32 pb-0 relative">
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 relative z-20">
          ...
          <h2 className="md:text-5xl leading-[1.15] text-3xl font-semibold text-ink tracking-tight font-display mb-6">
