    ...
    <div className="flex flex-col gap-8">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          {run.manifests.map((manifest) => (
            ...
            >
              ...
              <span
                aria-label="verified"
                className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-fit-green text-[13px] font-bold text-white"
              >
                ✓
              </span>
            </article>
        ...
        <dl className="mt-6 grid gap-4 border-t border-slate-100 pt-5 sm:grid-cols-2">
          <div>
            <dt className="mb-1 text-[13px] text-slate-500">
              Final output hash
            </dt>
            <dd>
          ...
          <div>
            <dt className="mb-1 text-[13px] text-slate-500">Protected term</dt>
            <dd className="font-mono text-[12px] text-slate-700">
              {run.edition.protectedTerms.join(", ")} · preserved
            </dd>
          </div>
          <div>
            <dt className="mb-1 text-[13px] text-slate-500">Captions</dt>
            <dd className="font-mono text-[12px] text-slate-700">
